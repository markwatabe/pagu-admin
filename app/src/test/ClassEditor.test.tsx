...
describe('ClassEditor', () => {
  describe('empty state', () => {
    it('shows placeholder when no node selected', () => {
      render(<ClassEditor node={null} dataModel={{}} onUpdate={vi.fn()} onRemove={vi.fn()} />)
  ...
  describe('typography pickers', () => {
    it('renders font size picker with current value', () => {
      render(<ClassEditor node={baseNode} dataModel={{}} onUpdate={vi.fn()} onRemove={vi.fn()} />)
    ...
    it('calls onUpdate with updated classes when size changes', () => {
      ...
      render(<ClassEditor node={baseNode} dataModel={{}} onUpdate={onUpdate} onRemove={vi.fn()} />)
  ...
  describe('remove button', () => {
    it('calls onRemove when Remove button clicked', () => {
      ...
      render(<ClassEditor node={baseNode} dataModel={{}} onUpdate={vi.fn()} onRemove={onRemove} />)
