...
export function AppHeader({ onToggleChat }: { onToggleChat: () => void }) {
          ...
          {navLinks.map(({ to, label }) => {
            ...
            return (
              <li key={to}>
                <Link
                  to={to}
                  className={`transition hover:text-indigo-600 ${isActive ? 'text-indigo-600 border-b-2 border-indigo-600 pb-1' : ''}`}
                >
                  {label}
                </Link>
              </li>
            ...
            {navLinks.map(({ to, label }) => {
              ...
              return (
                <li key={to}>
                  <Link
                    to={to}
                    className={`block rounded-md px-3 py-2 transition hover:bg-gray-50 hover:text-indigo-600 ${isActive ? 'bg-indigo-50 text-indigo-600' : ''}`}
                  >
                    {label}
                  </Link>
                </li>
